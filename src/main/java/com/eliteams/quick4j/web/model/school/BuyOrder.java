...
public class BuyOrder implements TBase<BuyOrder, BuyOrder._Fields>, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("BuyOrder");
  ...
  private static final TField BELONG_CANTEEN_FIELD_DESC = new TField("belongCanteen", TType.STRING, (short)4);
  private static final TField BELONG_SELLER_FIELD_DESC = new TField("belongSeller", TType.STRING, (short)5);
  ...
  private static final TField MENU_LIST_FIELD_DESC = new TField("menuList", TType.STRING, (short)8);
  private static final TField USER_ID_FIELD_DESC = new TField("userId", TType.STRING, (short)9);
  private static final TField DISTRIBUTOR_ID_FIELD_DESC = new TField("distributorId", TType.STRING, (short)10);
  private static final TField EXTRA_DATA1_FIELD_DESC = new TField("extraData1", TType.STRING, (short)11);
  private static final TField EXTRA_DATA2_FIELD_DESC = new TField("extraData2", TType.STRING, (short)12);
  private static final TField CREATE_TIME_FIELD_DESC = new TField("createTime", TType.I64, (short)13);
  private static final TField UPDATE_TIME_FIELD_DESC = new TField("updateTime", TType.I64, (short)14);
  private static final TField PAID_TIME_FIELD_DESC = new TField("paidTime", TType.I64, (short)15);
  private static final TField CANCEL_TIME_FIELD_DESC = new TField("cancelTime", TType.I64, (short)16);
  private static final TField FINISH_TIME_FIELD_DESC = new TField("finishTime", TType.I64, (short)17);
  ...
  public enum _Fields implements TFieldIdEnum {
    ...
    BELONG_CANTEEN((short)4, "belongCanteen"),
    BELONG_SELLER((short)5, "belongSeller"),
    TOTAL_PRICE((short)6, "totalPrice"),
    DISTRIBUTION_PRICE((short)7, "distributionPrice"),
    MENU_LIST((short)8, "menuList"),
    USER_ID((short)9, "userId"),
    DISTRIBUTOR_ID((short)10, "distributorId"),
    EXTRA_DATA1((short)11, "extraData1"),
    EXTRA_DATA2((short)12, "extraData2"),
    CREATE_TIME((short)13, "createTime"),
    UPDATE_TIME((short)14, "updateTime"),
    PAID_TIME((short)15, "paidTime"),
    CANCEL_TIME((short)16, "cancelTime"),
    FINISH_TIME((short)17, "finishTime");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 3: // STATUS
          return STATUS;
        case 4: // BELONG_CANTEEN
          return BELONG_CANTEEN;
        case 5: // BELONG_SELLER
  ...
  static {
    ...
    tmpMap.put(_Fields.DISTRIBUTION_PRICE, new FieldMetaData("distributionPrice", TFieldRequirementType.DEFAULT, 
        new FieldValueMetaData(TType.I64)));
    tmpMap.put(_Fields.MENU_LIST, new FieldMetaData("menuList", TFieldRequirementType.DEFAULT, 
        new FieldValueMetaData(TType.STRING)));
    ...
    FieldMetaData.addStructMetaDataMap(BuyOrder.class, metaDataMap);
  }
   ...
   */
  public BuyOrder(BuyOrder other) {
    ...
    if (other.isSetMenuList()) {
      this.menuList = other.menuList;
    }
  ...
  public BuyOrder setOrderId(String orderId) {
    this.orderId = orderId;
    return this;
  }
  ...
  public BuyOrder setStatus(String status) {
    this.status = status;
    return this;
  }
  ...
  public BuyOrder setBelongCanteen(String belongCanteen) {
    this.belongCanteen = belongCanteen;
    return this;
  }
  ...
  public BuyOrder setBelongSeller(String belongSeller) {
    this.belongSeller = belongSeller;
    return this;
  }
  ...
  public BuyOrder setTotalPrice(long totalPrice) {
    this.totalPrice = totalPrice;
    setTotalPriceIsSet(true);
    return this;
  }
  ...
  public BuyOrder setDistributionPrice(long distributionPrice) {
    this.distributionPrice = distributionPrice;
    setDistributionPriceIsSet(true);
    return this;
  }
  ...
  public BuyOrder setMenuList(String menuList) {
    this.menuList = menuList;
    return this;
  }

  public void unsetMenuList() {
    this.menuList = null;
  }

  /** Returns true if field menuList is set (has been asigned a value) and false otherwise */
  public boolean isSetMenuList() {
    return this.menuList != null;
  }

  public void setMenuListIsSet(boolean value) {
    if (!value) {
      this.menuList = null;
    }
  }
  ...
  public BuyOrder setUserId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public BuyOrder setDistributorId(String distributorId) {
    this.distributorId = distributorId;
    return this;
  }
  ...
  public BuyOrder setExtraData1(String extraData1) {
    this.extraData1 = extraData1;
    return this;
  }
  ...
  public BuyOrder setExtraData2(String extraData2) {
    this.extraData2 = extraData2;
    return this;
  }
  ...
  public BuyOrder setCreateTime(long createTime) {
    this.createTime = createTime;
    setCreateTimeIsSet(true);
    return this;
  }
  ...
  public BuyOrder setUpdateTime(long updateTime) {
    this.updateTime = updateTime;
    setUpdateTimeIsSet(true);
    return this;
  }
  ...
  public BuyOrder setPaidTime(long paidTime) {
    this.paidTime = paidTime;
    setPaidTimeIsSet(true);
    return this;
  }
  ...
  public BuyOrder setCancelTime(long cancelTime) {
    this.cancelTime = cancelTime;
    setCancelTimeIsSet(true);
    return this;
  }
  ...
  public BuyOrder setFinishTime(long finishTime) {
    this.finishTime = finishTime;
    setFinishTimeIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof BuyOrder)
      return this.equals((BuyOrder)that);
    return false;
  }

  public boolean equals(BuyOrder that) {
    if (that == null)
      return false;
    ...
    boolean this_present_menuList = true && this.isSetMenuList();
    boolean that_present_menuList = true && that.isSetMenuList();
    if (this_present_menuList || that_present_menuList) {
      if (!(this_present_menuList && that_present_menuList))
        return false;
      if (!this.menuList.equals(that.menuList))
        return false;
    }
  ...
  public int compareTo(BuyOrder other) {
    ...
    BuyOrder typedOther = (BuyOrder)other;
    ...
    lastComparison = Boolean.valueOf(isSetMenuList()).compareTo(typedOther.isSetMenuList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMenuList()) {
      lastComparison = TBaseHelper.compareTo(this.menuList, typedOther.menuList);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public void read(TProtocol iprot) throws TException {
    ...
    while (true)
    {
      ...
      switch (field.id) {
        ...
        case 8: // MENU_LIST
          if (field.type == TType.STRING) {
            this.menuList = iprot.readString();
          } else { 
            TProtocolUtil.skip(iprot, field.type);
          }
          break;
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.menuList != null) {
      oprot.writeFieldBegin(MENU_LIST_FIELD_DESC);
      oprot.writeString(this.menuList);
      oprot.writeFieldEnd();
    }
    if (this.userId != null) {
